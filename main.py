...
# load function for working with fonts separately
font.init()
...
lost = 0 #ships missed
max_lost = 4 #lose if you miss thatmany

#parent class for the other sprites
class GameSprite(sprite.Sprite):
    #class constructor
    def __init__(self, player_image, player_x, player_y, size_x, size_y, player_speed):
        #Call for the class (Sprite) constructir:
...
while run:
    ...
    if not finish:
        ...
        #update them in a new location in each loop iteraction
        ship.reset()
        monsters.draw(window)
        bullets.draw(window)
        
        # bullet-monster collisions check (both monster and bullet disappear upon touching)
        ...
        # possible loss: missed to many or the character collide with the enemy
